  ...
  return (
    <section id="material" className="section-padding overflow-hidden">
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="flex w-max animate-marquee transform-gpu gap-4 will-change-transform md:gap-6">
          {loop.map((img, i) => (
            <div
              key={i}
              className="h-[210px] w-[280px] shrink-0 overflow-hidden rounded-2xl border border-border bg-white shadow-lg shadow-primary/10 sm:h-[270px] sm:w-[360px] md:h-[340px] md:w-[480px]"
            >
              <img
                src={img.src}
                alt={img.alt}
